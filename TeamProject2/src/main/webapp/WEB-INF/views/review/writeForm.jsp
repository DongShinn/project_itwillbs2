...
<!--         <div class="row block-9"> -->
         <!-- <center>--> <div class="col-md-6 order-md-last d-flex">
            <form action="${pageContext.request.contextPath }/review/writePro" name="formname" method="post" enctype="multipart/form-data">
               
                   <select class="form-select" aria-label="Default select example" name="act_Num">
					  <option selected>체험명을 선택해 주세요</option>
					  <option value="1">클라이밍</option>
              ...
              <br>
               <br>
                <br>
                 <br>
					<div class="container">
					  <textarea class="summernote"  name="review_Context" placeholder="경험하신 체험을 자유롭게 작성하세요"></textarea>    
					</div>
					<script>
			  ...
			  <br>		
              <div class="form-group">
<!--                 <button name="submitBtn" type="button" title="submit" class="btn btn-primary py-3 px-5"> Submit </button> -->
