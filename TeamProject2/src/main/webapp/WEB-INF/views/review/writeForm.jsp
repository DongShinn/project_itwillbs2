...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/summernote/summernote-lite.css">
  ...
  <style>
	...
	$(document).ready(function () {
		...
		$("#starText").html($(this).attr('data-text'));
		});
	});
$(document).ready(function() {
...
<div id="write" class="col-lg-12 ftco-animate">
	<div class="container" style="padding: 0px 0px 60px">
		...
		<form action="${pageContext.request.contextPath }/review/writePro" id="join" method="post" enctype="multipart/form-data">
		<div style="margin-top: 1em;">
			<div class="left-box">글쓰기</div>
			<div class="right-box">
				<input type="submit" class="btn btn-primary" id="SendMessag" value="글쓰기">
			</div>
		</div>
		...
		<div>
			...
			<span class="star-rating" id="star-rating" >
				...
				<input type="radio" id="review_Score2" name="reviewScore"
					value="2"  data-text=좋음/> <label for="review_Score2"id="star-rating" class="star" data-text="그닥">&#9733;</label>
				<input type="radio" id="review_Score1" name="reviewScore"
					value="1"  data-text="아주좋음"/> <label for="review_Score1"id="star-rating" class="star" data-text="최악">&#9733;</label>
			</span>
		...
		<div style="margin-top: 0.5em;">
			<input type="text" id="reviewTitle" class="c-sub" name="reviewTitle" placeholder="제목을 입력해 주세요.">
		</div>
		<div class="content" style="margin-top: 0.5em;">
			 <textarea class="summernote" id="reviewContext" name="reviewContext" placeholder="경험하신 체험을 자유롭게 작성하세요"></textarea>  
				<script>
