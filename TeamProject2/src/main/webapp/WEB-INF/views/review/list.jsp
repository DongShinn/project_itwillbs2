							...
							<div class="block-27">
								<ul>
									...
									<c:if test="${RePageDTO.currentPage > 1}">
										<li><a href="${pageContext.request.contextPath}/review/list?pageNum=${RePageDTO.currentPage-1}">&lt;</a></li>
									</c:if>
								
									<c:forEach var="i" begin="${RePageDTO.startPage}" end="${RePageDTO.endPage}" step="1">
										<li><a class="paging" href="${pageContext.request.contextPath}/review/list?pageNum=${i}">${i}</a></li>
									</c:forEach>
