...
// 			alert("체험명을 입력하시오");
// 			$('input[name=actTitle]').focus();
// 			return false;
// 		}
// 		$("#d_fileCnt").append("<input type='hidden' value='"+cnt+"' name='fileCnt'>")
// 	}	
...
<body>
<input type="hidden" value="${sessionScope.userId}" name="companyId" id="companyId"> 
<div class="write-form">
	<div class="container">
		<div class="write-form2">
			<form action="${pageContext.request.contextPath }/activity/writePro" id="actForm" name="actForm" method="post" enctype="multipart/form-data" >
				<!-- 작성자 -->
				<div class="input-group mb-3">
					<span class="input-group-text2" id="inputGroup-sizing-default">회사명</span>
<!-- sessionID -> 회사명 넘어오는 값으로 바꿔야됨 -->
				<input type="text" class="form-control" value="" name="companyName" id="companyName" readonly>
				</div>
				<!-- 체험명 -->
				<div class="input-group mb-3">
					<span class="input-group-text2" id="inputGroup-sizing-default">체험명</span>
					<input type="text" class="form-control" id="actTitle" name="actTitle" maxlength="50">
				</div>
				<!-- 카테고리 -->
				<div class="input-group mb-3">
					...
					<select class="form-select" id="form-control" name="actCategory">
						...
						<c:forEach var="categoriesDto" items="${categoryList}">
							<option value="${categoriesDto.category}">${categoriesDto.category}</option>
						</c:forEach>
					</select>
				</div>
				<!-- 가격 -->
				...
				<input type="text" class="form-control" name="actPrice" id="actPrice" value="0" maxlength="20">
				</div>
				<!-- 문의변호 -->
				<div class="input-group mb-3">
					<span class="input-group-text2" id="inputGroup-sizing-default">문의번호</span>
				<input type="text" class="form-control" name="actPhone" id="actPhone" maxlength="15">
				</div>
				<div class="input-group mb-3">
					<span class="input-group-text2" id="inputGroup-sizing-default">위치</span>
				<input placeholder="클릭해주세요" type="text" class="form-control" name="actLocation" id="address_kakao" maxlength="50" readonly>
				</div>
				<!-- 내용 -->
				<div class="input-group mb-3">
					<span class="input-group-text2" id="inputGroup-sizing-default">내용</span>
				<textarea name="actContent" class="form-control" rows="10" cols="20" maxlength="500"></textarea>
				</div>
				<!-- 운영시간 -->
				<div class="input-group mb-3" >
				...
				<div class="input-group mb-3">
					...
					<input type="radio" class="btn-check" name="actDayoff" id="dayoff-yes" value="">
					<label class="btn btn-outline-secondary" for="dayoff-yes">있어요</label>
					<input type="radio" class="btn-check" value="연중무휴" name="actDayoff" id="dayoff-no" checked>
				...
				<div id="dayoff-cb3">
					<div class="input-group mb-3">	
						...
						<input type="checkbox" class="btn-check" id="actDayoff-sat" value="토요일" name="actDayoff">
						<label class="btn btn-outline-secondary" for="actDayoff-sat">토</label>
				...
				<div class="input-group mb-3 filebox" id="actImg1">
					...
					<label class="form-control input-group-text2" for="files1" id="lbFile1">첨부파일</label>
				...
				<div class="input-group mb-3 filebox" id="actImg2">
					<span class="input-group-text2" id="file">이미지</span>
					<label class="form-control input-group-text2" for="files2" id="lbFile2">첨부파일</label>
				...
				<div class="input-group mb-3 filebox" id="actImg3">
					<span class="input-group-text2" id="file">이미지</span>
					<label class="form-control input-group-text2" for="files3" id="lbFile3">첨부파일</label>
				...
				<div class="input-group mb-3 filebox" id="actImg4">
					<span class="input-group-text2" id="file">이미지</span>
					<label class="form-control input-group-text2" for="files4" id="lbFile4">첨부파일</label>
				...
				<div class="input-group mb-3 filebox" id="actImg5">
					<span class="input-group-text2" id="file">이미지</span>
					<label class="form-control input-group-text2" for="files5" id="lbFile5">첨부파일</label>
				...
				<div class="input-group mb-3 filebox" id="actImg6">
					<span class="input-group-text2" id="file">이미지</span>
					<label class="form-control input-group-text2" for="files6" id="lbFile6">첨부파일</label>
...
<script src="${pageContext.request.contextPath}/resources/js/actWriteForm.js"></script>
