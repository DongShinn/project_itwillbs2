				...
				<div class="filter-option">
					<section class="section-option">
						...
						<div class="option-detail">
							<div class="options">
								<label for="categoty_">
									<input type="checkbox" name="category" id="categoty_" value="" <c:if test="${actCategory == null}">checked="checked"</c:if>>전체
								</label>
							</div>
							<c:forEach var="categoriesDto" items="${categoryList}" varStatus="status" >
								<div class="options">
		                    		<label for="categoty_${status.index}">
										<input class="category-options" type="checkbox" name="category" id="categoty_${status.index}" value="${categoriesDto.category}"
										<c:if test="${categoriesDto.category eq actCategory}">checked="checked"</c:if>>${categoriesDto.category}
									</label>
								</div>
	                    	</c:forEach>
						</div>
