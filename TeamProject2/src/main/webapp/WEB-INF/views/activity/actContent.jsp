            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="product_details_text">
                        ...
                        <form action="${pageContext.request.contextPath}/order/order" name="actForm" method="post" enctype="multipart/form-data" id="actForm">
			                <div class="row mt-4">
								<div class="w-100"></div>
			 				...
			 				<div>
			 					...
			 					<input type="hidden" value="${sessionScope.userId}" name="user_id" id="user_id">
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		<div class="row">
	    			...
	    			<div class="col-md-6 col-lg-3 ftco-animate">
	    				<div class="product">
	    					...
	    					<div class="text py-3 pb-4 px-3 text-center">
	    						<h3><a href="${pageContext.request.contextPath }/review/content?review_Num=${reviewList.reviewNum}">${reviewList.reviewTitle}</a></h3>
	    						<div class="d-flex">
	    							<div class="pricing">
		    					...
		    					<div class="bottom-area d-flex px-3">
		    						<div class="m-auto d-flex">
		    							<a href="${pageContext.request.contextPath }/review/content?review_Num=${reviewList.reviewNum}" class="add-to-cart d-flex justify-content-center align-items-center text-center">
 		  	...
 		  	<div>
 		  	<input type="button" value="리뷰작성" class="btn btn-black py-3 px-5" id="btnReview"
        		onclick="location.href='${pageContext.request.contextPath }/review/write?actNum=${activityDto.actNum}'"> 
