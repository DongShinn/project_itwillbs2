...
<!-- 헤더파일들어가는 곳 -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="product_details_text">
                        ...
                        <form action="${pageContext.request.contextPath}/activity/writePro" name="actForm" method="post" enctype="multipart/form-data" >
			                <div class="row mt-4">
								<div class="w-100"></div>
			 				...
			 				<div>
			 					...
			 					<input type="hidden" value="${activityDto.actPrice}" name="ordPayPrice">
			       				<p><input type="submit" value="Buy" class="btn btn-black py-3 px-5"></p>
			       			</div>
		       			</form>
                    </div>
                </div>
    ...
    <section class="ftco-section">
        ...
        <p>위치 : ${activityDto.actLocation}</p>
          <input type="button" value="수정" class="btn btn-black py-3 px-5" 
          onclick="location.href='${pageContext.request.contextPath }/activity/update?actNum=${activityDto.actNum}'"> 
          <input type="button" value="삭제" class="btn btn-black py-3 px-5" 
