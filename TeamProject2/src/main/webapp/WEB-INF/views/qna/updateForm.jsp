<%@page import="com.itwillbs.dao.QnaDAO"%>
...
<body>
	<div class="container"> 
		<h1 style="font-size: 2rem; padding-left: 14.5em">글수정 문의</h1>
															<br>
		...
		<table border="1" class="table-fill">					
			<thead>
				...
				<tr><th class="text-left">글제목</th>
					 <td><input type="text" name="qnaSubject" value="${qnaDto.qnaSubject }"></td></tr>
					 
				<tr><th class="text-left">글내용</th>
					 <td><textarea name="qnaContent" rows="15" cols="30">${qnaDto.qnaContent }</textarea></td></tr> 
			</thead>
				
				
				</table>
					<div class="frame"><button class="custom-btn btn-2">글수정하기</button></div>
		  </form>
	</div>
															<br><br><br>
