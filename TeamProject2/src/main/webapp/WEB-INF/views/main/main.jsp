...
<!-- 	              <h2 class="mb-2" style="color:#000;">메인1... 사진추천받음..</h2> -->
<!-- 	              <h2 class="subheading mb-4" style="color:#000;">We deliver organic vegetables &amp; fruits</h2> -->
	              <h2 class="subheading mb-4" style="color:#000;">Give it a try, you'll love the workout!</h2>
	              <p><a href="#" class="btn btn-primary">ACTIVITY</a></p>
	            </div>
